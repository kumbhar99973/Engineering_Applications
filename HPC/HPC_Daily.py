...
try:
    p_1 = subprocess.Popen(["sudo","scp","-i","/home/cadrpt/.ssh/id_rsa",f"cadrpt@10.0.130.36:{server_path}punlsf-hpc-logs-{date_today}.txt",destination])
    sts_1 = os.waitpid(p_1.pid, 0)
    p_2 = subprocess.Popen(["sudo","scp","-i","/home/cadrpt/.ssh/id_rsa",f"cadrpt@10.0.130.36:{server_path}fralsf-hpc-logs-{date_today}.txt",destination])
    sts_2 = os.waitpid(p_2.pid, 0)
    p_3 = subprocess.Popen(["sudo","scp","-i","/home/cadrpt/.ssh/id_rsa",f"cadrpt@10.0.130.36:{server_path}whqlsf-hpc-logs-{date_today}.txt",destination])
