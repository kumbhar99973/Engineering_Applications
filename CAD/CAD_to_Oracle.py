...
config_path = "caxrpt@10.0.130.36:/home/caxrpt/reportdata/Engineering_application_config_file/config_CAD.py"
destination = "/home/ec2-user/AUTOCAD/"

p_5 = subprocess.Popen(["sudo","scp","-i","/home/caxrpt/.ssh/id_rsa",config_path,destination])
sts_5 = os.waitpid(p_5.pid, 0)

sys.path.append("/home/ec2-user/AUTOCAD")
import config_CAD as config1
