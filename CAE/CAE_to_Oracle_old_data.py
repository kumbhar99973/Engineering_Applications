...
from config_CAE1 import config as config
...
###########################################################
    ...
    prev_date_year_STR            = str(Curr_year_STR)
    ...
    for Day_of_the_Year_STR in range(1,365):
        len_Day_of_the_Year_STR = len(str(Day_of_the_Year_STR))
        if len_Day_of_the_Year_STR == 1:
            Day_of_the_Year_STR = '00'+str(Day_of_the_Year_STR)
        elif len_Day_of_the_Year_STR == 2:
            Day_of_the_Year_STR = '0'+str(Day_of_the_Year_STR)  
        else :
            Day_of_the_Year_STR = str(Day_of_the_Year_STR)
        for i in all_sites:
            for j in config[i].keys():
                ...
                f_usr_rm =  config[i][j]['user']+prev_date_year_STR+"-"+Day_of_the_Year_STR+".txt"
                f_lic_rm =  config[i][j]['license']+prev_date_year_STR+"-"+Day_of_the_Year_STR+".txt"
